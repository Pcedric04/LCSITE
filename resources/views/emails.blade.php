...
<body>
    <div class="container">
        ...
        @foreach ($posts as $post)
            <img src="{{ asset('front/admin/articles/',$post->photoIllustration) }}" alt="" style="float: left; height: 30px; width: 40px;">
            <h2 class="mb-2">
            ...
            <a href="{{ route('labo.front.actualites.details',$post->id) }}" class="mb-2">Lire la suite</a>
        @endforeach
