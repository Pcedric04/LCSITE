    ...
    <div class="modal-dialog modal-default">
        ...
        <div class="modal-body">
            <div class="card card-row ">
                    <form method="POST" action="{{ route('labo.back.gouvernances.update',$gouvernances->id) }}" id="africa-form-submit">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">Titre du rapport de gouvernances citoyennétés<span style="color:red;">*</span></label>
                                                    <textarea  class="form-control" name="titres" id="titres" cols="30" rows="5" title="Titre du rapport de gouvernances citoyennétés"
                                                    placeholder="Titre du rapport de gouvernances citoyennétés">{{ $gouvernances->titres }}</textarea>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="numero" id="numero" class="form-control" title="Numéros" placeholder="Numéros" value="{{ $gouvernances->numero }}">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="auteurs" id="auteurs" class="form-control" title="Auteurs" placeholder="Auteurs" value="{{ $gouvernances->auteurs }}">
                                                    <span class="auteurs_err error text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">Documents(PDF)<span style="color:red;">*</span> {{ $gouvernances->documents }}</label>
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" onclick="storeRecord()" id="sender" class="btn" style="background-color: #ff6902; color: white;">
                            ...
                            <b id="text-fix"><i class="fa fa-plus-circle"></i>Mis à jour</b>
                        </button>
                    </div>
            </div>
        </div>
