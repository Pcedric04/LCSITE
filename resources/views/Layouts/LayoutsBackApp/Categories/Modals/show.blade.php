        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card card-row ">
                        <form method="POST" action="{{ route('labo.back.categories.update',$categories->id) }}" id="africa-form-submit">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="categories" id="categories" value="{{ $categories->name }}" class="form-control" title="Catégories" placeholder="Catégories">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
