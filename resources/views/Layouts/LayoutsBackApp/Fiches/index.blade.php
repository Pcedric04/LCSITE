...
@section('title', 'Liste des rapports de fiches outils | Labo Citoyennetés')
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0" style="font-weight: 800">Liste des rapports de fiches outils</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li style="font-weight: 800;" class="breadcrumb-item active">
                                Liste des rapports de fiches outils
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 col-lg-12">
                        <a onclick="createRecord('{{ route('labo.back.fiches.create') }}')" title="Nouveau rapport" class="btn"
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    <table id="examples" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th style="width: 50%;">Titre du rapport de fiches outils</th>
                                                <th>Status</th>
                                                <th>Soumis par</th>
...
@section('js')
    <script>
        $('#examples').DataTable({
            ...
            ajax: '{{ route('labo.back.fiches.datatables') }}',
