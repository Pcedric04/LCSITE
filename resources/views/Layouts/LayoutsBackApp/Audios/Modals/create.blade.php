    ...
    <div class="modal-dialog modal-default">
        ...
        <div class="modal-body">
            <div class="card card-row ">
                    <form method="POST" action="{{ route('labo.back.audios.store') }}" id="africa-form-submit">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">Titre de l'audio<span style="color:red;">*</span></label>
                                                    <input type="text" name="titres" id="titres" class="form-control" title="Titre" placeholder="Titre de l'audio">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="url" name="liens" id="liens" class="form-control" title="URL" placeholder="Votre lien audio">
