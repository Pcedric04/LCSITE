    ...
    <div class="modal-dialog modal-default">
        ...
        <div class="modal-body">
            <div class="card card-row ">
                    <form method="POST" action="{{ route('labo.back.etudes.update',$etudes->id) }}" id="africa-form-submit">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">Titre du rapport de etudes-recit<span style="color:red;">*</span></label>
                                                    <textarea  class="form-control" name="titres" id="titres" cols="30" rows="5" title="Titre du rapport de etudes-recit"
                                                    placeholder="Titre du rapport de etudes-recit">{{ $etudes->titres }}</textarea>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="numero" id="numero" class="form-control" title="Numéros" placeholder="Numéros" value="{{ $etudes->numero }}">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="auteurs" id="auteurs" class="form-control" title="Auteurs" placeholder="Auteurs" value="{{ $etudes->auteurs }}">
                                                    <span class="auteurs_err error text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">Documents(PDF)<span style="color:red;">*</span> {{ $etudes->documents }}</label>
