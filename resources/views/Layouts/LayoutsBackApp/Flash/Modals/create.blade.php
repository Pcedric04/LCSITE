    ...
    <div class="modal-dialog modal-default">
        ...
        <div class="modal-body">
            <div class="card card-row ">
                    <form method="POST" action="{{ route('labo.back.infos.store') }}" id="africa-form-submit">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="flashinfos" id="flashinfos" class="form-control" title="Message flash" placeholder="Message flash">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">Lien url</label>
                                                    <input type="url" name="liens" id="liens" class="form-control" title="liens" placeholder="Url flash infos">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
