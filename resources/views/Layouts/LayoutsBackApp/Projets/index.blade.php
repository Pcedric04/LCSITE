...
@section('title', 'Liste des projets | Labo Citoyennetés')
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0" style="font-weight: 800">Liste des projets</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 col-lg-12">
                        <a onclick="createRecord('{{ route('labo.back.projets.create') }}')" title="Nouveau rapport" class="btn"
                            style="background-color: #ff6902; color: #fff;">
                            <i class="fa fa-plus-circle"></i><strong>Nouveau projet</strong>
                        </a>
                    </div>
                </div>
            </div>
...
@section('js')
    <script>
        $('#examples').DataTable({
            ...
            ajax: '{{ route('labo.back.projets.datatables') }}',
