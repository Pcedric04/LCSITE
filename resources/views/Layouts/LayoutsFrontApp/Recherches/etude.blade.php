...
@section('title', 'Etudes RECIT-Labo Citoyennetés')
@section('content')
    @include('Layouts.LayoutsFrontApp.Banner.etudebanner')
        ...
        <div class="container-fluid">
                        ...
                        <div class="img-fluid">
                            <table class="table table-striped">
                                ...
                                <tbody style="text-align: left;">
                                    @foreach ($etudes as $etudes_items)
                                        <tr>
                                            <td>
                                                {{ $etudes_items->titres }}
                                            </td>
                                            ...
                                            <td>
                                                {{ $etudes_items->auteurs }}
                                            </td>
                                            <td>
                                                <a href="{{ asset('PDF/Rapport/' . $etudes_items->documents) }}"
                                                    target="_blank">
            ...
            <div id="social-links" class="mb-2">
                <ul style="display:inline; ">
                    <li>
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('labo.front.etude.index') }}"
                            class="social-button" id=""><span class="fab fa-facebook"></span>
                        </a>
                    </li>
                    <li>
                        <a href="https://twitter.com/intent/tweet?text=my share text&amp;url={{ route('labo.front.etude.index') }}"
                            class="social-button" id=""><span class="fab fa-twitter"></span>
                        </a>
                    </li>
                    <li>
                        <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('labo.front.etude.index') }}"
                            class="social-button" id=""><span class="fab fa-linkedin"></span>
                        </a>
                    </li>
                    <li>
                        <a href="https://wa.me/?text={{ route('labo.front.etude.index') }}" class="social-button"
