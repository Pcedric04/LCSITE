...
@section('title', 'Niger-Labo Citoyennetés')
@section('content')
    @include('Layouts.LayoutsFrontApp.Banner.zonenigerbanner')
    <!-- MotdeBienvenu Start -->
            ...
            <div class="row">
                <div class="col-lg-8 col-md-9">
                    <div class="service">
                        <div class="service-text rounded p-5">
                            ...
                            <img class="img-fluid" style="width: auto" src="{{ asset('Front/img/Accueil/niger-carte.jpg') }}"
                ...
                <div id="social-links" class="mb-2">
                    <ul style="display:inline; ">
                        <li>
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ route('labo.front.zone.niger.index') }}"
                                class="social-button" id=""><span class="fab fa-facebook"></span>
                            </a>
                        </li>
                        <li>
                            <a href="https://twitter.com/intent/tweet?text=my share text&amp;url={{ route('labo.front.zone.niger.index') }}"
                                class="social-button" id=""><span class="fab fa-twitter"></span>
                            </a>
                        </li>
                        <li>
                            <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url={{ route('labo.front.zone.niger.index') }}"
                                class="social-button" id=""><span class="fab fa-linkedin"></span>
                            </a>
                        </li>
                        <li>
                            <a href="https://wa.me/?text={{ route('labo.front.zone.niger.index') }}"
