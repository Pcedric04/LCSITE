...
@section('title', 'Appels d\'offres | Labo Citoyennetés')
@section('content')
    @include('Layouts.LayoutsFrontApp.Banner.offresbanner')
                                ...
                                <div class="card-body p-0">
                                    <table class="table table-striped">
                                        ...
                                        <tbody style="text-align: center;">
                                            <tr>
                                                {{-- <td>#2023-LC/02</td> --}}
                                                <td><strong>Avis d’appel public à candidature</strong></td>
                                                <td><strong>La Fondation Hanns Seidel (FHS) en collaboration avec le
                                                        Laboratoire Citoyennetés (LC)</strong></td>
