...
@section('content')
    {{-- @include('Layouts.LayoutsFrontApp.Banner.registerbanner') --}}
    <!-- Login Start -->
                            ...
                            <form>
                                <div class="">
                                    ...
                                    <span class="h1 fw-bold mb-0"><img
                                            src="{{ asset('Front/img/logo.png') }}" alt=""
                                            style="width: 30%"></span>
                                </div>

                                <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Créer votre
                                    compte</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-outline mb-4">
                                            <input style="width: 100%;" type="text" id="surname"
                                                name="surname" class="form-control form-control-lg" />
                                            <label class="form-label" for="surname">Prénom(s)</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-outline mb-4">
                                ...
                                <div class="pt-1 mb-4">
                                    <button class="btn bg-primary btn-lg text-white btn-block" type="button">Valider</button>
                                </div>
                                <p class="pb-lg-2" style="color: #ff6902;"><a
                                        href="{{ route('labo.front.users.index') }}"
                                        style="color: #ff6902;"><i class="fa fa-user"></i> J'ai déja un
                                        compte!</a></p>
                            </form>
                        </div>
                    </div>
