...
@section('title', 'Liste des audios-Laboratoire Citoyennetés')
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0" style="font-weight: 800">Liste des audios</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 col-lg-12">
                        <a onclick="createRecord('{{ route('labo.back.audios.create') }}')" title="Nouvelle Actualité" class="btn"
                            style="background-color: #ff6902; color: #fff;">
                            <i class="fa fa-plus-circle"></i><strong> Nouvel audio</strong>
                        </a>
                    </div>
                </div>
            </div>
...
@section('js')
    <script>
        $('#examples').DataTable({
            ...
            ajax: '{{ route('labo.back.audios.datatables') }}',

            columns: [{
                    data: 'url',
                    name: 'url',
                    render: function render(data, type, full, meta) {
                       /*  var files = '{!! asset('Articles/') !!}'; */
                        return '<div class="d-flex flex-wrap align-items-center">' +
                            '<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">' +
                            '<div class="symbol-label">'+
                            '<iframe width="auto" height="100" src="' + data + '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>' +
                            '</div>' +
                            '</div>' +
                            '</div>';
                    }
