...
@section('title', 'Flash-Labo Citoyennetés')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0" style="font-weight: 800">Flash infos</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a onclick="createRecord('{{ route('labo.back.infos.create') }}')" title="Nouveau" class="btn" style="background-color: #ff6902; color: #fff;">
                            <i class="fa fa-plus-circle"></i><strong>Nouvel infos</strong>
                        </a>
                    </div>
                </div>
            </div>
