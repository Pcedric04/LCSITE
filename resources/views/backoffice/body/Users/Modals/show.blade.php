    ...
    <div class="modal-dialog modal-default">
        ...
        <div class="modal-body">
            <div class="card card-row ">
                    <form method="POST" action="{{ route('labo.back.users.update',$users->id) }}" id="africa-form-submit">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="name" class="form-control" value="{{ $users->name }}" title="Nom(s) utilisateur" placeholder="Entrer le(s) nom(s)">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="surname" id="surname" class="form-control" value="{{ $users->surname }}" title="Prénom(s) utlisateur" placeholder="Entrer le(s) prénoms(s)">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nickname" id="nickname" class="form-control" value="{{ $users->nickname }}" title="Pseudo utlisateur" placeholder="Entrer le pseudo de l'utilisateur">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" id="email" class="form-control" value="{{ $users->email }}" title="Email utlisateur" placeholder="Entrer l'email de l'utilisateur">
