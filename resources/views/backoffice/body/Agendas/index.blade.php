...
@section('title', 'Liste des agendas | Labo Citoyennetés')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0" style="font-weight: 800">Liste des agendas</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 col-lg-12">
                        <a onclick="createRecord('{{ route('labo.back.agendas.create') }}')" title="Nouvelle agenda"
                            class="btn" style="background-color: #ff6902; color: #fff;">
                            <i class="fa fa-plus-circle"></i><strong> Nouvelle agenda</strong>
                        </a>
                    </div>
                </div>
            </div>
...
@section('js')
    <script>
        $('#examples').DataTable({
            ...
            ajax: '{{ route('labo.back.agendas.datatables') }}',
