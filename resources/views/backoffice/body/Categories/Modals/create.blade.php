    ...
    <div class="modal-dialog modal-default">
        ...
        <div class="modal-body">
            <div class="card card-row ">
                    <form method="POST" action="{{ route('labo.back.categories.store') }}" id="africa-form-submit">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">Titre de la catégorie<span style="color: red;">*</span></label>
                                                    <input type="text" name="categories" id="categories" class="form-control" title="Catégories" placeholder="Titre de la catégorie">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
