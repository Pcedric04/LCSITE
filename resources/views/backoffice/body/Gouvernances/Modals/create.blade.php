    ...
    <div class="modal-dialog modal-default">
        ...
        <div class="modal-body">
            <div class="card card-row ">
                    <form method="POST" action="{{ route('labo.back.gouvernances.store') }}" id="africa-form-submit">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="titres" id="titres" cols="20" rows="5" title="Titre du rapport de gouvernances citoyennétés" placeholder="Titre du rapport de gouvernances citoyennétés"></textarea>
