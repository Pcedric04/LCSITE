...
@section('title', 'Liste des articles | Labo Citoyennetés')
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0" style="font-weight: 800">Liste des articles</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 col-lg-12">
                        <a href="{{ route('labo.back.actualites.create') }}" title="Nouvelle Actualité" class="btn"
                            style="background-color: #ff6902; color: #fff;">
                            <i class="fa fa-plus-circle"></i><strong>Nouvelle article</strong>
                        </a>
                        @permission('posts-restore')
                            <a href="{{ route('labo.back.actualites.restore.index') }}" title="Article(s) supprimé" class="btn"
                                style="background-color: red; color: #fff;">
                                <i class="fa fa-trash"></i><strong>Article(s) supprimé(s)</strong>
                            </a>
                        @endpermission
                    </div>
                </div>
...
@section('js')
    <script>
        $('#examples').DataTable({
            ...
            ajax: '{{ route('labo.back.actualites.datatables') }}',

            columns: [{
                    data: 'photoIllustration',
                    name: 'photoIllustration',
                    render: function render(data, type, full, meta) {
                        var files = '{!! asset('front/admin/articles/') !!}';
                        return '<div class="d-flex flex-wrap align-items-center">' +
                            '<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">' +
                            '<div class="symbol-label">' +
                            '<img src="' + files + '/' + data + '" style="width: 120px; height: 60px;" />' +
                            '</div>' +
                            '</div>' +
                            '</div>';
                    }
        ...
        }).buttons().container().appendTo('#examples .col-md-6:eq(0)');
    </script>
@endsection
