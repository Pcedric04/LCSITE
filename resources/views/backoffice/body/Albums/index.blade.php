...
@section('title', 'Liste des albums | Labo Citoyennetés')
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0" style="font-weight: 800">Liste des albums</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12 col-lg-12">
                        <a href="{{ route('labo.back.albums.create') }}" title="Nouvelle albums" class="btn"
                            style="background-color: #ff6902; color: #fff;">
                            <i class="fa fa-plus-circle"></i><strong> Nouvel album</strong>
                        </a>
                    </div>
                </div>
            </div>
...
@section('js')
    <script>
        $('#examples').DataTable({
            ...
            ajax: '{{ route('labo.back.albums.datatables') }}',

            columns: [{
                    data: 'logo',
                    name: 'logo',
                    render: function render(data, type, full, meta) {
                        var files = '{!! asset('front/albums/') !!}';
