    ...
    <div class="modal-dialog modal-default">
        ...
        <div class="modal-body">
            <div class="card card-row ">
                    <form method="POST" action="{{ route('labo.back.souscategories.store') }}" id="africa-form-submit">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">Titre de la sous-catégorie<span style="color: red;">*</span></label>
                                                    <input type="text" name="souscategories" id="souscategories" class="form-control" title="Sous-Catégories" placeholder="Titre de la sous-catégorie">
                                                    <span class="souscategories_err error text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="inputSuccess">Catégories associées<span style="color: red;">*</span></label>
