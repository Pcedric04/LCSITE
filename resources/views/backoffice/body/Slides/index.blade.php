...
@section('title', 'Slides-Labo Citoyennetés')
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0" style="font-weight: 800">Slides</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a onclick="createRecord('{{ route('labo.back.slides.create') }}')" title="Nouveau" class="btn" style="background-color: #ff6902; color: #fff;">
                            <i class="fa fa-plus-circle"></i><strong>Nouveau slide</strong>
                        </a>
                    </div>
                </div>
            </div>
...
<script>
    $('#examples').DataTable({
        ...
        ajax: '{{ route('labo.back.slides.datatables') }}',
        ...
        columns: [
            {
                ...
                render: function render(data, type, full, meta) {
                        var files = '{!! asset('front/admin/slides/') !!}';
