...
@section('title', 'Audios-Labo Citoyennétés')
@section('banner', 'Audios')
@section('content')
    <!--/ Header end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mb-4 mb-lg-0">
                    ...
                    <div class="container">
                        <div class="row">
                        @foreach ($audios as $items)
                        <div class="col-lg-4 col-md-6 mb-5">
                            <div class="ts-service-box">
                                <div class="ts-service-image-wrapper">
                                    <iframe style="width:100%;" height="200" src="{{ $items->url }}" title="YouTube video player"
                                        frameborder="0"
                                ...
                                <div class="d-flex">
                                  <div class="ts-service-info">
                                      <h3 class="service-box-title"><a href="{{ route('labo.front.audios.details',$items->id) }}">{{ $items->titre }}</a></h3>
                                      <a class="learn-more d-inline-block" href="{{ route('labo.front.audios.details',$items->id) }}" aria-label="service-details">
