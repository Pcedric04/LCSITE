                            ...
                            <div class="ts-service-box">
                                ...
                                <div class="d-flex">
                                  <div class="ts-service-info">
                                      <h3 class="service-box-title"><a href="{{ route('labo.front.videos.details',$items->id) }}">{{ $items->titre }}</a></h3>
                                      <a class="learn-more d-inline-block" href="{{ route('labo.front.videos.details',$items->id) }}" aria-label="service-details">
