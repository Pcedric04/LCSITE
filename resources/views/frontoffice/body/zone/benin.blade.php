...
@section('title','Zone Bénin-Labo Citoyennétés')
@section('banner','Zone Bénin')
@section('content')
<!--/ Header end -->
            ...
            <div class="service">
                <div class="service-text mb-2">
                    <div class="responsive">
                        <img class="img-fluid" style="width: auto" src="{{ asset('front/public/images/acceuil/carte-murale-benin_0.jpg') }}" alt="Burkina">
                    </div>
                    <p
