...
@section('title','Zone Niger-Labo Citoyennétés')
@section('banner','Zone Niger')
@section('content')
<!--/ Header end -->
            ...
            <div class="service">
                <div class="service-text mb-2">
                    <div class="responsive">
                        <img class="img-fluid" style="width: auto" src="{{ asset('front/public/images/acceuil/niger-carte.jpg') }}" alt="Niger">
                    </div>
                    <p
