...
@section('title','Publications-Labo Citoyennétés')
            ...
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><a href="#"><img width="60"
                            src="{{ asset('front/public/couverture/' . $items->couverture) }}"
                            alt=""></a></td>
                        <td>{{ $items->name}}</td>
                        <td>{{ $items->pays}}</td>
                        <td><a href="{{ asset('PDF/Publications/' . $items->documents) }}"
