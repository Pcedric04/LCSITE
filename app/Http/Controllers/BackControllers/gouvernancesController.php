    ...
    public function datatables()
        {
            ...
            return dataTables()->of($gouvernances)->addColumn('actions', function ($gouvernances) {
                return view('Layouts.LayoutsBackApp.Gouvernances.Actions.actions', ['gouvernances' => $gouvernances]);
            })->toJson();
        }
    public function index()
        {
            return view('Layouts.LayoutsBackApp.Gouvernances.index');
        }

    public function create()
        {
            return view('Layouts.LayoutsBackApp.Gouvernances.Modals.create');
        }
    ...
    public function store(Request $request)
        {
            ...
            $user = Auth::user()->id;
                ...
                if($request->hasFile('documents')){
                    ...
                    request()->documents->move(public_path('PDF/Gouvernances'), $documents1);
    ...
    public function show($id)
        {
            ...
            return view('Layouts.LayoutsBackApp.Gouvernances.Modals.show', compact('gouvernances'));
        }
