    ...
    public function datatables()
        {
            ...
            return dataTables()->of($publications)->addColumn('actions', function ($publications) {
                return view('Layouts.LayoutsBackApp.Publications.Actions.actions', ['publications' => $publications]);
            })->toJson();
        }
    public function index()
        {
            return view('Layouts.LayoutsBackApp.Publications.index');
        }

    public function create()
        {
            return view('Layouts.LayoutsBackApp.Publications.Modals.create');
        }
 ...
 public function store(Request $request)
        {
            ...
            $user = Auth::user()->id;
                ...
                if($request->hasFile('pages')){
                    ...
                    request()->pages->move(public_path('Couverture'), $documentspage1);
                ...
                if($request->hasFile('documents')){
                    ...
                    request()->documents->move(public_path('PDF/Publications'), $documents1);
        ...
        public function show($id)
        {
            ...
            return view('Layouts.LayoutsBackApp.Publications.Modals.show', compact('publications'));
        }
