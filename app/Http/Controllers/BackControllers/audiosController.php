    ...
    public function datatablesAudios()
        {
            ...
            return dataTables()->of($audios)->addColumn('actions', function ($audios) {
                return view('Layouts.LayoutsBackApp.Audios.Actions.actions', ['audios' => $audios]);
            })->toJson();
        }
    public function indexAudios()
        {
            return view('Layouts.LayoutsBackApp.Audios.index');
        }

    public function createAudios()
        {
            $categories = categories::where('status', '=', 'En ligne')->get();
            return view('Layouts.LayoutsBackApp.Audios.Modals.create',['categories'=>$categories]);
        }

    public function random_souscategories($id)
        {
            $souscategories = categoriesService::souscategories($id);
            return view('Layouts.LayoutsBackApp.Audios.Partials.souscategories', ['souscategories'=>$souscategories]);
        }
    ...
    public function showAudios($id)
        {
            ...
            $categories = categories::where('status', '=', 'En ligne')->get();
            return view('Layouts.LayoutsBackApp.Audios.Modals.show', compact('audios','categories'));
        }
