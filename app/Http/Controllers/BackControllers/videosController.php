...
class videosController extends Controller
{
    ...
    public function datatablesVideos()
    {
        ...
        return dataTables()->of($videos)->addColumn('actions', function ($videos) {
            return view('Layouts.LayoutsBackApp.Videos.Actions.actions', ['videos' => $videos]);
        })->toJson();
    }
    public function indexVideos()
    {
        return view('Layouts.LayoutsBackApp.Videos.index');
    }

    public function createVideos()
    {
        $categories = categories::where('status', '=', 'En ligne')->get();
        return view('Layouts.LayoutsBackApp.Videos.Modals.create', ['categories' => $categories]);
    }
    ...
    public function showVideos($id)
    {
        ...
        $categories = categories::where('status', '=', 'En ligne')->get();
        return view('Layouts.LayoutsBackApp.Videos.Modals.show', compact('videos','categories'));
    }
