    ...
    public function datatables()
        {
            ...
            return dataTables()->of($etudes)->addColumn('actions', function ($etudes) {
                return view('backoffice.body.Etudes.Actions.actions', ['etudes' => $etudes]);
            })->toJson();
        }
    public function index()
        {
         ...
         if ($photo != null) {
            ...
            return view('backoffice.body.Etudes.index',compact('photo'));
        }

    public function create()
        {
            return view('backoffice.body.Etudes.Modals.create');
        }
    ...
    public function store(Request $request)
        {
            ...
            $user = Auth::user()->id;
                ...
                if($request->hasFile('documents')){
                    ...
                    request()->documents->move(public_path('front/admin/pdf/etudes'), $documents1);
    ...
    public function show($id)
        {
            ...
            return view('backoffice.body.Etudes.Modals.show', compact('etudes'));
        }
    ...
    public function update($id, Request $request)
        {
            ...
            $etudes->users_id = $user;
            $etudes->save();
            return view('backoffice.body.Etudes.index');
        }
