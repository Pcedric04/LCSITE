...
class capitalisationsController extends Controller
{
    ...
    public function datatables()
        {
            ...
            return dataTables()->of($capitalisations)->addColumn('actions', function ($capitalisations) {
                return view('backoffice.body.Capitalisations.Actions.actions', ['capitalisations' => $capitalisations]);
            })->toJson();
        }
    ...
    public function create()
        {
            return view('backoffice.body.Capitalisations.Modals.create');
        }
    ...
    public function store(Request $request)
        {
            ...
            $user = Auth::user()->id;
                ...
                if($request->hasFile('documents')){
                    ...
                    request()->documents->move(public_path('front/admin/pdf/rapport'), $documents1);
