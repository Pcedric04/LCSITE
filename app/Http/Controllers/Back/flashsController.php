...
class flashsController extends Controller
{
    ...
    public function datatables()
    {
        ...
        return dataTables()->of($flashinfos)->addColumn('actions', function ($flashinfos) {
            return view('backoffice.body.Flash.Actions.actions', ['flashinfos' => $flashinfos]);
        })->toJson();
    }
    ...
    public function index()
    {
        ...
        return view('backoffice.body.Flash.index',compact('photo'));
    }
    public function create()
    {
        return view('backoffice.body.Flash.Modals.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('backoffice.body.Flash.Modals.show', compact('flash'));
    }
