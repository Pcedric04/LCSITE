...
class usersController extends Controller
{
    ...
    public function datatables()
    {
        ...
        if ($user->hasRole('superadministrateur')) {
                ...
                return dataTables()->of($users)->addColumn('actions', function ($users) {
                    return view('backoffice.body.Users.Actions.actions', ['users' => $users]);
                })->toJson();
            }
            else{
                $users = DB::table('users')->join('role_user', 'role_user.user_id', '=', 'users.id')
    ...
    public function index()
        {
         ...
         if ($photo != null) {
            ...
            return view('backoffice.body.Users.index',compact('photo'));
        }
    public function create()
        {
        $roles = Role::get();
        return view('backoffice.body.Users.Modals.create', compact('roles'));
        }
    ...
    public function show($id)
        ...
        $roles = Role::get();
        return view('backoffice.body.Users.Modals.show',['users'=>$users,'roles'=>$roles]);
        }
