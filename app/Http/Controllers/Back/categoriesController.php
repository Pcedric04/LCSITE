...
class categoriesController extends Controller
{
    ...
    public function datatables()
    {
        ...
        return dataTables()->of($categories)->addColumn('actions', function ($categories) {
            return view('backoffice.body.Categories.Actions.actions', ['categories' => $categories]);
        })->toJson();
    }
    public function index()
    {
        ...
        return view('backoffice.body.Categories.index',compact('photo'));
    }

    public function create()
    {
        return view('backoffice.body.Categories.Modals.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('backoffice.body.Categories.Modals.show',compact('categories'));
    }
    public function update(Request $request,$id)
    {
        ...
        $categories->users_id = $user;
        $categories->save();
        return view('backoffice.body.Categories.index');
    }
