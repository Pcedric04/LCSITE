    ...
    public function datatables()
        {
            ...
            return dataTables()->of($fiches)->addColumn('actions', function ($fiches) {
                return view('backoffice.body.Fiches.Actions.actions', ['fiches' => $fiches]);
            })->toJson();
        }
    public function index()
        {
         ...
         if ($photo != null) {
            ...
            return view('backoffice.body.Fiches.index',compact('photo'));
        }

    public function create()
        {
            return view('backoffice.body.Fiches.Modals.create');
        }
    ...
    public function store(Request $request)
        {
            ...
            $user = Auth::user()->id;
                ...
                if($request->hasFile('documents')){
                    ...
                    request()->documents->move(public_path('front/admin/pdf/fiches'), $documents1);
    ...
    public function show($id)
        {
            ...
            return view('backoffice.body.Fiches.Modals.show', compact('fiches'));
        }
    ...
    public function update($id, Request $request)
        {
            ...
            $fiches->users_id = $user;
            $fiches->save();
            return view('backoffice.body.Fiches.index');
        }
