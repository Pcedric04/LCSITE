...
class souscategoriesController extends Controller
{
    ...
    public function datatables()
    {
      ...
      /*   ->select(
        ...
        return dataTables()->of($souscategories)->addColumn('actions', function ($souscategories) {
            return view('backoffice.body.SousCategories.Actions.actions', ['souscategories' => $souscategories]);
        })->toJson();
    }
    public function index()
    {
        ...
        return view('backoffice.body.SousCategories.index',compact('photo'));
    }
    public function create()
    {
        $categories = categories::all();
        return view('backoffice.body.SousCategories.Modals.create',compact('categories'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backoffice.body.SousCategories.Modals.show',compact('souscategories','categories'));
    }
